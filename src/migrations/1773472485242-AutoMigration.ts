...
export class AutoMigration1773472485242 implements MigrationInterface {
    name = 'AutoMigration1773472485242'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user_info\` (\`id\` int NOT NULL AUTO_INCREMENT, \`gender\` tinyint NOT NULL, \`birthYear\` int NOT NULL, \`height\` float NOT NULL, \`weight\` float NOT NULL, \`activity\` tinyint NOT NULL, \`goal\` tinyint NOT NULL, \`target_weight\` float NOT NULL, \`target_calories\` int NOT NULL, \`target_ratio\` json NOT NULL, \`userId\` int NOT NULL, UNIQUE INDEX \`REL_3a7fa0c3809d19eaf2fb4f6594\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
